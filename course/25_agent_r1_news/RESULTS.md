...
数据泄漏审计：2880 条训练任务样本来自 960 篇独立新闻，960 条验证任务样本来自 320 篇独立新闻；正文 SHA-256、基础新闻 ID 和完整任务 `record_id` 的训练/验证交集均为 0。每篇新闻都严格展开为 retrieve、compose、decision 三个任务，没有缺失或重复展开。
